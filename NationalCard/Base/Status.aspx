...
<head id="Head1" runat="server">
    ...
    <link href="../App_Themes/Default_Blue/XBlue.css" rel="stylesheet" type="text/css" />
</head>
<body>
            ...
            <tr>
                <td height="200" style="width: 750px">
                    <anthem:DataGrid ID="gvMaster" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        Style="direction: rtl" DataKeyField="StatusID" AllowSorting="True" OnItemDataBound="gvMaster_ItemDataBound"
                        ...
                        <Columns>
                            ...
                            <TABLE dir="rtl" cellSpacing="0" cellPadding="0" border="0">
                                <TR>
                                    ...
                                    <TD width="100px">
                                        <%# ((PNationalCard.Definition.Status)Container.DataItem).StatusID%>
                                    </TD>
                                    <TD width="300px">
                                        <%# ((PNationalCard.Definition.Status)Container.DataItem).StatusDesc%>
                                    </TD>
                                    <TD width=20>
                                    ...
                                    <table width="500">
                                        <tr>
                                            <td width="100">
                                                کد وضعيت :</td>
                                            <td width="400">
                                                <anthem:Label ID="lblStatusID" runat="server" AutoUpdateAfterCallBack="True" Enabled="False"></anthem:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="100" valign="top">
                                                شرح وضعيت :</td>
                                            <td width="400">
                                                <anthem:TextBox Width="390px" ID="txtStatusDesc" runat="server" AutoUpdateAfterCallBack="True"
                                                    Enabled="False" Height="100px" TextMode="MultiLine"></anthem:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </anthem:Panel>
