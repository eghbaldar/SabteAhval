            ...
            <tr>
                <td height="200" style="width: 750px">
                    <anthem:DataGrid ID="gvMaster" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        Style="direction: rtl" DataKeyField="OfficeID" AllowSorting="True" OnItemDataBound="gvMaster_ItemDataBound"
                        ...
                        <Columns>
                            ...
                            <TABLE dir="rtl" cellSpacing="0" cellPadding="0" border="0">
                                <TR>
                                    ...
                                    <TD width="100px">
                                        <%# ((PNationalCard.Definition.Office)Container.DataItem).OfficeID%>
                                    </TD>
                                    <TD width="200px">
                                        <%# ((PNationalCard.Definition.Office)Container.DataItem).OfficeName%>
                                    </TD>
                                    <TD width="300px">
                                        <%# ((PNationalCard.Definition.Office)Container.DataItem).Address%>
                                    </TD>
                                    <TD width=20>
                                    ...
                                    <table width="500">
                                        <tr>
                                            <td width="100">
                                                کد اداره :</td>
                                            <td width="400">
                                                <anthem:TextBox Width="100" ID="txtOfficeID" runat="server" AutoUpdateAfterCallBack="True"
                                        ...
                                        <tr>
                                            <td width="100">
                                                نام اداره :</td>
                                            <td width="400">
                                                <anthem:TextBox Width="300px" ID="txtOfficeName" runat="server" AutoUpdateAfterCallBack="True"
                                                    Enabled="False" MaxLength="100"></anthem:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="100" valign="top">
                                                آدرس :</td>
                                            <td width="400">
                                                <anthem:TextBox Width="390px" ID="txtAddress" runat="server" AutoUpdateAfterCallBack="True"
                                                    Enabled="False" Height="100px" MaxLength="200"></anthem:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </anthem:Panel>
