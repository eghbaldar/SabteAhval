...
public partial class Status : System.Web.UI.Page
{
    ...
    private void SetDelete(int ItemIndex)
    {
        ...
        else
        {
            ...
            PNationalCard.Definition.Status obj;
            obj = PNationalCard.Definition.NCollections.Status[key];
            if (obj != null)
                if (obj.Delete())
                {
                    LoadData();
    ...
    private void SetSave()
    {
        if (this.pageStatus == HNP.Base.Enum.PageStatus.Edit || this.pageStatus == HNP.Base.Enum.PageStatus.New)
        {
            ...
            {
                PNationalCard.Definition.Status obj = new PNationalCard.Definition.Status();
            ...
            else
            {
                ...
                PNationalCard.Definition.Status obj = PNationalCard.Definition.NCollections.Status[key];
                this.ReadControlsValue(obj);
                if (obj.Update())
                {
    ...
    private void ReadControlsValue(PNationalCard.Definition.Status obj)
    {
        if (pageStatus != HNP.Base.Enum.PageStatus.New)
            obj.StatusID = short.Parse(this.lblStatusID.Text);
        obj.StatusDesc = this.txtStatusDesc.Text;
    }

    private void LoadData()
    {
        this.gvMaster.DataSource = PNationalCard.Definition.NCollections.Status.GetAll;
    ...
    private void loadControls(short key)
    {
        ...
        if (obj != null)
        {
            this.lblStatusID.Text = obj.StatusID.ToString();
            this.txtStatusDesc.Text = obj.StatusDesc.ToString();
        }
    }
