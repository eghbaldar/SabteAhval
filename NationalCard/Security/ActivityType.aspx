<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActivityType.aspx.cs" Inherits="ActivityType"
            ...
            <tr>
                <td height="200" style="width: 750px">
                    <anthem:DataGrid ID="gvMaster" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        Style="direction: rtl" DataKeyField="ActivityTypeID" AllowSorting="True" OnItemDataBound="gvMaster_ItemDataBound"
                        ...
                        <Columns>
                            ...
                            <TABLE dir="rtl" cellSpacing="0" cellPadding="0" border="0">
                                <TR>
                                    ...
                                    <TD width="100px">
                                        <%# ((HNP.Security.Difinition.ActivityType)Container.DataItem).ActivityTypeID%>
                                    </TD>
                                    <TD width="300px">
                                        <%# ((HNP.Security.Difinition.ActivityType)Container.DataItem).ActivityTypeName%>
                                    </TD>
                                    <TD width=20>
                                    ...
                                    <table width="500">
                                        <tr>
                                            <td width="100">
                                                کد :</td>
                                            <td width="400">
                                                <anthem:Label ID="lblActivityTypeID" runat="server" AutoUpdateAfterCallBack="True"
                                        ...
                                        <tr>
                                            <td width="100">
                                                نوع فعاليت :</td>
                                            <td width="400">
                                                <anthem:TextBox Width="300" ID="txtActivityTypeName" runat="server" AutoUpdateAfterCallBack="True"
