<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActivityTypeAction.aspx.cs"
    Inherits="ActivityTypeAction" Title="" StylesheetTheme="Default_Blue" %>

<%@ Register Assembly="Anthem" Namespace="Anthem" TagPrefix="anthem" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>انتساب عمل به نوع فعاليت</title>
</head>
<body>
            ...
            <tr>
                <td height="200" style="width: 750px">
                    <anthem:DataGrid ID="gvMaster" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        Style="direction: rtl" DataKeyField="ATAID" AllowSorting="True" OnItemDataBound="gvMaster_ItemDataBound"
                        ...
                        <Columns>
                            ...
                            <TABLE dir="rtl" cellSpacing="0" cellPadding="0" border="0">
                                <TR>
                                    ...
                                    <TD width="100px">
                                        <%# ((HNP.Security.Difinition.ActivityTypeAction)Container.DataItem).ATAID %>
                                    </TD>
                                    <TD width="200px">
                                        <%# ((HNP.Security.Difinition.ActivityTypeAction)Container.DataItem).ActivityType.ActivityTypeName %>
                                    </TD>
                                    <TD width="200px">
                                        <%# ((HNP.Security.Difinition.ActivityTypeAction)Container.DataItem).Action.ActionName %>
                                    </TD>
                                    <TD width=20>
                                    ...
                                    <table width="500">
                                        <tr>
                                            <td width="100">
                                                کد :</td>
                                            <td width="400">
                                                <anthem:Label ID="lblATAID" runat="server" AutoUpdateAfterCallBack="True" Enabled="False"></anthem:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="100">
                                                نوع فعاليت :</td>
                                            <td width="400">
                                                <anthem:DropDownList ID="drpActivityTypeID" runat="server" AutoUpdateAfterCallBack="True"
                                                    DataTextField="ActivityTypeName" DataValueField="ActivityTypeID" Enabled="False" Width="250px">
                                                </anthem:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="100">
                                                عمل :</td>
                                            <td width="400">
                                                <anthem:DropDownList ID="drpActionID" runat="server" AutoUpdateAfterCallBack="True"
                                                    Enabled="False" Width="250px" DataTextField="ActionName" DataValueField="ActionID">
                                                </anthem:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
