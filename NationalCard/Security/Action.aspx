            ...
            <tr>
                <td height="200" style="width: 750px">
                    <anthem:DataGrid ID="gvMaster" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        Style="direction: rtl" DataKeyField="ActionID" AllowSorting="True" OnItemDataBound="gvMaster_ItemDataBound"
                        ...
                        <Columns>
                            ...
                            <TABLE dir="rtl" cellSpacing="0" cellPadding="0" border="0">
                                <TR>
                                    ...
                                    <TD width="100px">
                                        <%# ((HNP.Security.Difinition.Action)Container.DataItem).ActionID%>
                                    </TD>
                                    <TD width="300px">
                                        <%# ((HNP.Security.Difinition.Action)Container.DataItem).ActionName%>
                                    </TD>
                                    <TD width=20>
                                    ...
                                    <table width="500">
                                        <tr>
                                            <td width="100">
                                                کد عمل :</td>
                                            <td width="400">
                                                <anthem:Label ID="lblActionID" runat="server" AutoUpdateAfterCallBack="True" Enabled="False"></anthem:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="100">
                                                نام عمل :</td>
                                            <td width="400">
                                                <anthem:TextBox Width="200px" ID="txtActionName" runat="server" AutoUpdateAfterCallBack="True"
