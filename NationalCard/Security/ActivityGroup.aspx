<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActivityGroup.aspx.cs" Inherits="ActivityGroup"
...
<head runat="server">
    <title>انتساب فعاليت به گروه</title>
</head>
<body>
            ...
            <tr>
                <td height="200" style="width: 750px">
                    <anthem:DataGrid ID="gvMaster" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        Style="direction: rtl" DataKeyField="ActivityGroupID" AllowSorting="True" OnItemDataBound="gvMaster_ItemDataBound"
                        ...
                        <Columns>
                            ...
                            <TABLE dir="rtl" cellSpacing="0" cellPadding="0" border="0">
                                <TR>
                                    ...
                                    <TD width="100px">
                                        <%# ((HNP.Security.Difinition.ActivityGroup)Container.DataItem).ActivityGroupID%>
                                    </TD>
                                    <TD width="100px">
                                        <%# ((HNP.Security.Difinition.ActivityGroup)Container.DataItem).Activity.ActivityName %>
                                    </TD>
                                    <TD width="100px">
                                        <%# ((HNP.Security.Difinition.ActivityGroup)Container.DataItem).ATA.ATADesc %>
                                    </TD>
                                    <TD width="100px">
                                        <%# ((HNP.Security.Difinition.ActivityGroup)Container.DataItem).Group.GroupName %>
                                    </TD>
                                    <TD width=20>
                                    ...
                                    <table width="500">
                                        <tr>
                                            <td width="100">
                                                کد :</td>
                                            <td width="400">
                                                <anthem:Label ID="lblActivityGroupID" runat="server" AutoUpdateAfterCallBack="True"
                                                    Enabled="False"></anthem:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="100">
                                                کد فعاليت :</td>
                                            <td width="400">
                                                <anthem:DropDownList ID="ddlActivity" runat="server" AutoUpdateAfterCallBack="True"
                                                    DataTextField="ActivityName" DataValueField="ActivityID" Enabled="False" Width="300px">
                                                </anthem:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="100">
                                                کد نوع فعاليت عمل :</td>
                                            <td width="400">
                                                <anthem:DropDownList ID="ddlATA" runat="server" AutoUpdateAfterCallBack="True"
                                                    DataTextField="ATADesc" DataValueField="ATAID" Enabled="False" Width="300px">
                                                </anthem:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="100">
                                                کد گروه :</td>
                                            <td width="400">
                                                <anthem:DropDownList ID="ddlGroup" runat="server" AutoUpdateAfterCallBack="True"
                                                    DataTextField="GroupName" DataValueField="GroupID" Enabled="False" Width="300px">
                                                </anthem:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <table style="border-right: cornflowerblue 1px solid; border-top: cornflowerblue 1px solid;
                                    ...
                                    <tr>
                                        <td colspan="2" align="center" width="150">
                                            <asp:ImageButton ID="btnHome" runat="server" ImageUrl="~/Images/home.png" OnClick="btnHome_Click" ToolTip="صفحه اصلي" /></td>
                                        <td colspan="2" align="center" width="150">
                                            <asp:ImageButton ID="btnExit" runat="server" ImageUrl="~/Images/exit.png" OnClick="btnExit_Click" ToolTip="خروج" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
