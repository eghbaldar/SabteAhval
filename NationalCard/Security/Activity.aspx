            ...
            <tr>
                <td height="200" style="width: 750px">
                    <anthem:DataGrid ID="gvMaster" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        Style="direction: rtl" DataKeyField="ActivityID" AllowSorting="True" OnItemDataBound="gvMaster_ItemDataBound"
                        ...
                        <Columns>
                            ...
                            <TABLE dir="rtl" cellSpacing="0" cellPadding="0" border="0">
                                <TR>
                                    ...
                                    <TD width="100px">
                                        <%# ((HNP.Security.Difinition.Activity)Container.DataItem).ActivityID%>
                                    </TD>
                                    <TD width="100px">
                                        <%# ((HNP.Security.Difinition.Activity)Container.DataItem).ActivityType.ActivityTypeName %>
                                    </TD>
                                    <TD width="200px">
                                        <%# ((HNP.Security.Difinition.Activity)Container.DataItem).ActivityName%>
                                    </TD>
                                    <TD width="200px">
                                        <%# ((HNP.Security.Difinition.Activity)Container.DataItem).ActivityDesc%>
                                    </TD>
                                    <TD width=20>
                                    ...
                                    <table width="500">
                                        <tr>
                                            <td width="100">
                                                کد فعاليت :</td>
                                            <td width="400">
                                                <anthem:Label ID="lblActivityID" runat="server" AutoUpdateAfterCallBack="True" Enabled="False"></anthem:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="100">
                                            ...
                                            <td width="400">
                                                <anthem:DropDownList ID="drpActivityTypeID" runat="server" AutoUpdateAfterCallBack="True"
                                                    DataTextField="ActivityTypeName" DataValueField="ActivityTypeID" Enabled="False" Width="200px">
                                                </anthem:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="100">
                                                نام فعاليت :</td>
                                            <td width="400">
                                                <anthem:TextBox Width="200" ID="txtActivityName" runat="server" AutoUpdateAfterCallBack="True"
                                        ...
                                        <tr>
                                            <td width="100">
                                                شرح فعاليت :</td>
                                            <td width="400">
                                                <anthem:TextBox Width="300px" ID="txtActivityDesc" runat="server" AutoUpdateAfterCallBack="True"
                                                    Enabled="False"></anthem:TextBox>
                                            </td>
                                        </tr>
                                    </table>
