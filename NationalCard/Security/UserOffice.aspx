<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserOffice.aspx.cs" Inherits="UserOffice"
    Title="انتساب کاربر به اداره" StylesheetTheme="Default_Blue" %>
            ...
            <tr>
                <td height="200" style="width: 750px">
                    <anthem:DataGrid ID="gvMaster" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        Style="direction: rtl" DataKeyField="UserOfficeID" AllowSorting="True" OnItemDataBound="gvMaster_ItemDataBound"
                        ...
                        <Columns>
                            ...
                            <TABLE dir="rtl" cellSpacing="0" cellPadding="0" border="0">
                                <TR>
                                    ...
                                    <TD width="100px">
                                        <%# ((HNP.Security.Difinition.UserOffice)Container.DataItem).UserOfficeID%>
                                    </TD>
                                    <TD width="200px">
                                        <%# ((HNP.Security.Difinition.UserOffice)Container.DataItem).User.UserName %>
                                    </TD>
                                    <TD width="200px">
                                        <%# ((HNP.Security.Difinition.UserOffice)Container.DataItem).Office.OfficeName %>
                                    </TD>
                                    <TD width=20>
                                    ...
                                    <table width="450">
                                        <tr>
                                            <td width="100">
                                                کد :</td>
                                            <td width="350">
                                                <anthem:Label ID="lblUserOfficeID" runat="server" AutoUpdateAfterCallBack="True"
                                        ...
                                        <tr>
                                            <td width="100">
                                                کاربر :</td>
                                            <td width="350">
                                                <anthem:DropDownList ID="drpUser" runat="server" AutoUpdateAfterCallBack="True" Enabled="False"
                                                    Width="200px" DataTextField="UserName" DataValueField="UserID">
                                                </anthem:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="100">
                                                اداره :</td>
                                            <td width="350">
                                                <anthem:DropDownList ID="drpOffice" runat="server" AutoUpdateAfterCallBack="True"
