...
public partial class Group : System.Web.UI.Page
{
    ...
    private void SetDelete(int ItemIndex)
    {
        ...
        else
        {
            ...
            HNP.Security.Difinition.Group obj;
            obj = HNP.Security.Difinition.SecurityCollections.Group[key];
            if (obj != null)
                if (obj.Delete())
                {
                    LoadData();
    ...
    private void SetSave()
    {
        if (this.pageStatus == HNP.Base.Enum.PageStatus.Edit || this.pageStatus == HNP.Base.Enum.PageStatus.New)
        {
            ...
            {
              HNP.Security.Difinition.Group obj = new HNP.Security.Difinition.Group();
            ...
            else
            {
                ...
                HNP.Security.Difinition.Group obj = HNP.Security.Difinition.SecurityCollections.Group[key];
                this.ReadControlsValue(obj);
                if (obj.Update())
                {
    ...
    private void ReadControlsValue(HNP.Security.Difinition.Group obj)
    {
        if (pageStatus != HNP.Base.Enum.PageStatus.New)
            obj.GroupID = short.Parse(this.lblGroupID.Text);
        obj.GroupName = this.txtGroupName.Text;
    }

    private void LoadData()
    {
        this.gvMaster.DataSource = HNP.Security.Difinition.SecurityCollections.Group.GetAll;
    ...
    private void loadControls(short key)
    {
        ...
        if (obj != null)
        {
        this.lblGroupID.Text = obj.GroupID.ToString();
