            ...
            <tr>
                <td height="200" style="width: 750px">
                    <anthem:DataGrid ID="gvMaster" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        Style="direction: rtl" DataKeyField="UserGroupID" AllowSorting="True" OnItemDataBound="gvMaster_ItemDataBound"
                        ...
                        <Columns>
                            ...
                            <TABLE dir="rtl" cellSpacing="0" cellPadding="0" border="0">
                                <TR>
                                    ...
                                    <TD width="100px">
                                        <%# ((HNP.Security.Difinition.UserGroup)Container.DataItem).UserGroupID%>
                                    </TD>
                                    <TD width="200px">
                                        <%# ((HNP.Security.Difinition.UserGroup)Container.DataItem).User.UserName %>
                                    </TD>
                                    <TD width="100px">
                                        <%# ((HNP.Security.Difinition.UserGroup)Container.DataItem).Group.GroupName %>
                                    </TD>
                                    <TD width=20>
                                    ...
                                    <table width="500">
                                        <tr>
                                            <td width="100">
                                                کد کاربر گروه :</td>
                                            <td width="400">
                                                <anthem:Label ID="lblUserGroupID" runat="server" AutoUpdateAfterCallBack="True" Enabled="False"></anthem:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="100">
                                                کاربر :</td>
                                            <td width="400">
                                                <anthem:DropDownList ID="drpUserID" runat="server" AutoUpdateAfterCallBack="True"
                                                    Enabled="False" Width="200px" DataTextField="UserName" DataValueField="UserID">
                                                </anthem:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="100">
                                                گروه :</td>
                                            <td width="400">
                                                <anthem:DropDownList ID="drpGroupID" runat="server" AutoUpdateAfterCallBack="True"
                                                    Enabled="False" Width="200px" DataTextField="GroupName" DataValueField="GroupID">
                                                </anthem:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
